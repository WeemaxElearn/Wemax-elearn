...
export default class AddCourse extends Component {
	constructor(props) {
		...
		this.onChangeCourseImage = this.onChangeCourseImage.bind(this);
	...
	componentDidMount() {
		...
		axios
			.get('https://weemaxelearn.in/api/categories/')
			.then((response) => {
	...
	onSubmit(e) {
		...
		axios
			.post('https://weemaxelearn.in/api/course/add', newTodo)

			.then((result) => {
				this.props.history.push(
					'/add-lecture/' + this.props.match.params.id
				);
			});
	}
	render() {
							...
							<form onSubmit={this.onSubmit}>
								...
								<div className="form-group">
									...
									<input
										...
										onChange={this.onChangeCourseImage}
									/>
								</div>
								<div className="form-group">
