...
export default class UserEdit extends Component {
  ...
  componentDidMount() {
    axios
      .get("http://localhost:5000/user?id=" + this.props.match.params.id)
      .then((response) => {
    ...
    axios
      .get("http://localhost:5000/showroles/")
      .then((response) => {
  ...
  delete(id) {
    console.log(id);
    axios
      .delete("http://localhost:5000/user?id=" + this.props.match.params.id)
      .then((result) => {
  ...
  onSubmit = (e) => {
    ...
    axios
      .put("http://localhost:5000/user?id=" + this.props.match.params.id, {
        first_name,
        last_name,
        email,
        password,
